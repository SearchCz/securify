...
Its only responsibility is to interpret the current condition and continuously evaluate its significance. It activates in response to detected vunerabiity, sets its brightness value to reg=flect the alert score approriate to that vulnerabiliy. 
